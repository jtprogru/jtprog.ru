...
Думаю для базовой диагностики упомянутой в этой статье информации достаточно. Рядом полезно держать разбор [что показывает `top`](/posts/linux-top/) и [`strace`](/posts/strace/) — когда виновник найден, но непонятно, чем он занят. На этом всё! Profit!
