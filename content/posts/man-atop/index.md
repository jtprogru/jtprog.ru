...
Думаю для базовой диагностики упомянутой в этой статье информации достаточно. Рядом полезно держать разбор [что показывает `top`](/posts/linux-top/) и [`strace`](/posts/strace/) — когда виновник найден, но непонятно, чем он занят. А чтобы история из `atop` складывалась в диагноз, а не в набор красивых графиков, нужен метод: [про системный разбор поломки](https://jtprogru.github.io/The-Way-of-SRE/engineering/systematic-troubleshooting/) есть отдельный лист. На этом всё! Profit!
