...
Думаю на этом можно пока притормозить. На первое время хватит и этих данных. Когда таблицы перестанут влезать в одну — читай про [партицирование в PostgreSQL](/posts/partitioning/). На этом всё!
