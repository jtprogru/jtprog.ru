...
aliases:
  - '/interview-task-0003/'
title: 'Задачка с собеса 0003'
description: "Реальный пример архитектурной задачи с технического собеседования: проектирование высоконагруженного веб-сервиса, масштабирование, выбор инфраструктуры, советы по прохождению подобных интервью."
keywords: ["архитектурная задача собеседование", "интервью devops", "масштабирование веб-сервиса", "инфраструктура для стартапа", "техническое собеседование", "kubernetes архитектура", "devops интервью вопросы", "инфраструктура highload", "советы по собеседованию"]
...
cover:
  ...
  relative: false
type: post
slug: interview-task-0003
---

Привет, `%username%`! Очередная задача с собесов, которая является вариацией [задачи 0002](https://t.me/jtprogru_channel/4084), но не менее интересная из-за своих нюансов и условий – она про архитектуру.
...
- Трейсинг запросов – позволит отследить конкретный запрос пользователя и оценить «чойта он более 15sec выполняется всегда», а из каких слоёв этот путь вообще состоит – разбирал в заметке [«Что происходит, когда ты открываешь сайт»](https://jtprog.ru/posts/what-happens-when-you-open-website/);
- Алертинг – в мониторинге который не кричит о проблеме нет никакого смысла, а подробнее читай заметку [«Мониторинг: что/куда/зачем?»](https://jtprog.ru/posts/wat-monitoring/);
