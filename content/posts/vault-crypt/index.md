...
Отмечаем пункт "Восстановить параметры системы и предыдущие версии файлов". Это для надежности так сказать :-). Но можно и выбрать второй пункт "Восстановить только предыдущие версии файлов".
...
После этого просто приучитесь делать точки восстановления системы или настройте этот вопрос по такой [инструкции](/posts/windows-restore-point/) на нужную вам периодичность. Ещё один слой защиты «от дурака» — [Shadow Defender](/posts/shadow-defender/).
...
Похожая история с другого конца — [как шифровальщик прилетел через письмо сотруднику](/posts/bad-story/). А базовая гигиена, с которой всё начинается, — [сложные пароли и 2FA понятным языком](/posts/passwords-for-parents/).
