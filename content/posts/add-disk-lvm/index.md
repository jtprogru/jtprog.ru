...
По соседним темам: если место нужно не под данные, а под подкачку — [добавление SWAP в систему](/posts/linux-add-swap/); а если раздел живёт на Btrfs, диски туда добавляются [своими командами](/posts/btrfs-dev/).
