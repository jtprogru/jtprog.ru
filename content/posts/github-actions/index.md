...
Вариантов ведения блога у меня было уже несколько, о чем можно почитать в той же статье на [Medium](https://jtprog.medium.com/как-и-зачем-я-веду-свой-блог-cd0c429f9ffa), [тут](https://jtprog.ru/posts/gohugo/) и [тут](https://jtprog.ru/posts/gitlab-ci/), так что описывать причины я не вижу смысла.
...
![hugo-rsync-deployment](img/hugo-rsync-deployment.png)
...
Позже в этот же пайплайн добавился шаг с [IndexNow](/posts/indexnow/), чтобы поисковики узнавали о новом посте сразу после деплоя. А как я вообще оказался на Hugo — в [«Основательном и бесповоротном переезде»](/posts/gohugo/). Про соседний вариант того же самого на GitLab — [«GitLab-CI – делаем себе просто»](/posts/gitlab-ci/).
