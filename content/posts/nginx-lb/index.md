...
Балансировка — это только один этаж отказоустойчивости, про остальные — в [«Кластеризация и доступность»](/posts/ha-clustering/). Про соседние настройки nginx: [виртуальные хосты](/posts/virt-host-nginx/) и [логи в JSON](/posts/nginx-json-logs/), чтобы потом было что грепать.
