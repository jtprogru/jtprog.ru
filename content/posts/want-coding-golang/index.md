...
С чего это всё начиналось — в [«Программирование и работа»](/posts/dev-and-work/), где я выписывал себе роадмап и брался за Python.

А если по ходу автоматизации захочется копнуть глубже, в сторону структур данных и алгоритмов под эксплуатацию – глянь мой проект [dsa-for-ops](https://jtprogru.github.io/dsa-for-ops/).

Сколько именно языка нужно эксплуатационщику и где проходит граница «дальше уже не скрипт, а сервис» — [в листе про языки программирования](https://jtprogru.github.io/The-Way-of-SRE/engineering/programming-languages/) из карты компетенций SRE.
