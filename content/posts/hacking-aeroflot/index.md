...
description: "Краткий разбор ситуации взлома инфраструктуры Аэрофлота"
keywords:
  - взлом Аэрофлот
  - разбор взлома Аэрофлот
  - как взломали Аэрофлот
...
- Подрядчик с доступом в прод — это часть твоей инфраструктуры, а не «чужой периметр»: Zero Trust, нормальный мониторинг его активности, регулярные аудиты и право выключить доступ до полной зачистки. Разложено по шагам в листах [Access Control & IAM](https://jtprogru.github.io/The-Way-of-SRE/practices/access-control-iam/) и [Vendor Reliability](https://jtprogru.github.io/The-Way-of-SRE/practices/vendor-reliability/).
- SOC, который видит 3% сети, — это не экономия, а иллюзия контроля: [телеметрия](/posts/wat-monitoring/) должна покрывать не только «красивые» узлы, но и прикладные системы, через которые тихо двигаются злоумышленники.
...
- Резервное копирование — это не только про наличие бэкапов, но и про стратегию восстановления: из какой точки, какие доверенные снапшоты, как не вернуть в прод уже скомпрометированные артефакты. Простое правило из [листа про backup и restore](https://jtprogru.github.io/The-Way-of-SRE/engineering/backup-restore/): без регулярно проверенного восстановления бэкапа у тебя нет.

Собранный в одну систему, этот чек-лист и есть [Digital Immune System](/posts/digital-immune-system/) — только строить её надо до инцидента, а не в режиме «рубим питание по этажам».
