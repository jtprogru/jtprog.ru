...
1. **SLO без error budget policy — это украшение дашборда.** Контракт из SLO делает записанное правило: что происходит, когда бюджет сгорел, и кто принимает по этому поводу решение. Само число ничего не гарантирует. Без правила — это график, мимо которого все ходят.
...
4. **Метрики SRE-команды при мультипродукте раскладываются на три слоя** (надёжность продуктов / инженерное усилие / качество диалога) — один агрегат тут не справляется. Среднее по больнице — MTTR, composite SLO, число инцидентов — прячет ровно то, ради чего метрику заводили.
...
Формальную рамку вокруг того же самого — как выглядит регулярный ритуал ревью бюджета, кто в нём сидит и на каком языке разговаривает с не-инженерами — я разложил в карте компетенций: [SLO / Budget Review](https://jtprogru.github.io/The-Way-of-SRE/culture/slo-budget-review/) и [Stakeholder Management](https://jtprogru.github.io/The-Way-of-SRE/culture/stakeholder-management/).
