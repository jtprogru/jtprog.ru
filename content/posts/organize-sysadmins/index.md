...
aliases:
  - '/organize-sysadmins/'
title: 'Как организовать команду сисадминов'
...
Если ты по другую сторону этой истории и только устраиваешься в новую команду — [«Как зарекомендовать себя»](/posts/prove-yourself/) написано ровно про это. А про то, как перестать держать знания в голове одного человека, — [«Документация, Сухой поцелуй и джуны»](/posts/rtfm-dry-kiss/).

Тогда я собирал всё это интуитивно и по наитию. Сейчас у каждой из этих штук есть имя и накопленная практика: [дизайн команд и когнитивная нагрузка](https://jtprogru.github.io/The-Way-of-SRE/culture/team-topologies/) вместо анкет на коленке и [онбординг](https://jtprogru.github.io/The-Way-of-SRE/culture/sre-onboarding/) вместо «разберётся по ходу».
