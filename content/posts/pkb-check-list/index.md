...
Начну, как обычно с конца – зачем вести персональную базу знаний? Ответ максимально прост и сложен одновременно. Данных и информации на нас сегодня валится столько, сколько обычному человеку 50-100 лет назад даже не снилось. А если ты еще и связал свою жизнь с IT, то эти объемы еще выше, т.к. это особенность данной сферы деятельности человека. Мозг человека за тот же период не сильно эволюционировал, поэтому часто можно слышать про "_выгорание_", "_высокую когнитивную нагрузку на работе_" и все такое в этом духе. Мозгу нужно помогать, а одним из инструментов помощи может стать персональная база знаний.

Персональную базу знаний имеет смысл заводить тогда, когда ты сам решил помочь своему мозгу.

![f5e34917-b39e-4780-a06a-6e7e68baaa83.webp](img/f5e34917-b39e-4780-a06a-6e7e68baaa83.webp)

## Чек-лист: с какой стороны подойти
...
Организация персональной базы знаний ради организации базы знаний – идея максимально провальная. Ты должен понимать, к чему ты стремишься. Например, хорошая и чёткая цель – сохранить и доступно организовать знания, чтобы работать/учиться более эффективно.
...
Как это выглядит у меня внутри — со структурой папок, PARA и живыми примерами — я показал в [«Содержимое моей персональной базы знаний»](/posts/inside-my-obsidian/). Про выбор редактора под заметки есть отдельный разбор — [«Редактор текста»](/posts/text-editor/). И маленькое предупреждение: если хранилище лежит в облаке и синхронизируется с нескольких устройств, почитай, [как облачная синхронизация ломает git](/posts/cloud-sync-breaks-git/).
