...
---
Привет, `%username%`! Неожиданно для себя я открыл такую файловую систему как BTRFS. Если ты с ней ещё не знаком, начни с [«Btrfs - что это и как это»](/posts/btrfs-man/) — там про подтома, снапшоты и базовые команды.
