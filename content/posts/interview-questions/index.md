...
Выглядит довольно просто, но я бы хотел остановиться на некоторых пунктах и пояснить, что по моему мнению считается важным. Как минимум потому, что я был по обе стороны баррикады — про сторону кандидата я отдельно писал в [«Я прошел 50 собесов и вот что я понял»](/posts/after-50-interview/).
...
У тебя с интервьюером общий язык на котором вы оба говорите и оба понимаете. Я могу порекомендовать со своей стороны лишь одно: веди свой GitHub/GitLab профиль! Указывай ссылки на свой профиль в резюме! Это будет играть тебе на руку в дальнейшем как минимум тем, что можно будет показывать примеры своих наработок. Те кто сейчас подняли ведра с помидорами чтоб меня закидать – остыньте! Я не говорю о том, что нужно брать и как есть выкладывать на GitHub все свои наработки. Я к примеру сделал некоторое количество [ansible-ролей](/posts/ansible-roles/), в максимально унифицированном виде – их можно применить к чему угодно.
...
Если ответы плавающие — скорее всего инфра растёт быстрее выручки, и это сигнал. Что за этими вопросами стоит с инженерной стороны — [в листе про управление стоимостью облака](https://jtprogru.github.io/The-Way-of-SRE/engineering/cloud-cost-control/).
...
Ответы дадут понять, kubernetes у них «работает потому что работает», или у команды есть осмысленная операционная модель. Список того, что про кластер стоит знать помимо `kubectl`, — [в листе про контейнеры и оркестрацию](https://jtprogru.github.io/The-Way-of-SRE/engineering/container-orchestration/).
