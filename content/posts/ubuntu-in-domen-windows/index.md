...
Про тот же домен, но с другой стороны — [«Знакомство с виртуальными серверами»](/posts/welcom-to-virtualisation/), где я поднимал контроллеры домена и ловил грабли с репликацией из-за времени.
