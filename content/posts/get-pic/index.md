...
Из той же серии мелких скриптов на Python: [бот, который жалуется на провайдера в Twitter](/posts/bad-isp-twbot/) и [генератор отмазок на Redis](/posts/twitter-excuse/). А зачем я вообще полез в код — в [«Программирование и работа»](/posts/dev-and-work/).
