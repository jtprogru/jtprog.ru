...
Практическая часть по слоям: [балансировка бэкендов на nginx](/posts/nginx-lb/) и [репликация Master-Slave](/posts/master-slave/) для базы. А как договариваться о том, сколько именно доступности нужно бизнесу, — в [«Надёжность строится в диалоге с бизнесом»](/posts/reliability-is-a-conversation/).
