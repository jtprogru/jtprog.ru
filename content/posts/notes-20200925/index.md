...
Впереди еще тонны извинений в адрес коллег, сетевиков, жены, собаки, кота. А так же повторение матчасти по базовым вещам: [основы Ansible](/posts/ansible-basic/) и [авторизация по ssh-ключу](/posts/ssh-keys/).
