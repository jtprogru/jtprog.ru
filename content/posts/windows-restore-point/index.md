...
title: 'Автоматическое создание точек восстановления Windows'
type: post
...
Зачем это вообще нужно — наглядно видно в истории про [шифровальщик Vault](/posts/vault-crypt/): откат системы там оказался единственным рабочим способом вернуть файлы.
