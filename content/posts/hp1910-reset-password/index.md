...
Затем измените настройки подключения:
...
## Прерываем загрузку и входим в BootROM
...
## Пропускаем сохранённую конфигурацию
...
## Быстрая настройка адреса через ipsetup
...
Подробнее про первоначальную настройку данного коммутатора — в отдельном посте: [первый запуск HP 1910](/posts/hp1910-first-run/).
