...
Следующий шаг — разложить плейбуки по [ролям и обвязать их Molecule](/posts/ansible-roles/). И одна история из практики о том, как не надо: [заметка на полях про `ansible.cfg` и ssh](/posts/notes-20200925/).
