...
Итоги подводить пока рано, потому что каких-либо внятных (по моим меркам внятных) достижений еще нет. По моим меркам "внятное достижение" – это "написать свой сервис". Не "микросервис", а полноценную взрослую штуку. Например сервис отложенных постов для своего [Telegram-канала](https://t.me/+gLeURJwFz5Q4NTA6), или еще что-то подобное.
