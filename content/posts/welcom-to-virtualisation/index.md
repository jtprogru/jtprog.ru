...
## Однодоменная или многодоменная
...
Про грабли, которые ждут дальше на этом же стенде: [сброс триала на ESXi](/posts/reset-trial-esxi/), [ошибки vCenter Converter Standalone](/posts/error-converter-standalone/) и [починка машины после конвертации](/posts/centos-after-convert/).
