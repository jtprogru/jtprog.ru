...
Если пароль нужен себе и прямо в терминале — [генерируем в CLI](/posts/cli-gen-pass/). А про то, чем заканчивается «да кому я нужен», у меня есть две старые истории с фронта: [спам и шифрование](/posts/bad-story/) и [очередной шифровальщик](/posts/vault-crypt/).
