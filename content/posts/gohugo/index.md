...
Что выросло вокруг этого переезда потом: [сборка и деплой на GitHub Actions](/posts/github-actions/), [моментальная переиндексация через IndexNow](/posts/indexnow/) и [ребрендинг с редизайном](/posts/rebranding-design/).
