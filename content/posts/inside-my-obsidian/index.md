...
- **[Чек-лист для организации персональной базы знаний](https://jtprog.ru/posts/pkb-check-list/)** — публичный артефакт в блоге.
...
У меня есть в блоге [Чек-лист для организации персональной базы знаний](https://jtprog.ru/posts/pkb-check-list/) — если хочешь начать, это хорошая отправная точка. Также было небольшое выступление перед студентами РТУ МИРЭА про знакомство с личной базой знаний ([слайды](https://jtprogru.github.io/pkbd/) есть, а видео нет).
