...
Да, этот способ – это очередное подтверждение того, что ops должен уметь кодить (хотя бы на уровне говнокода) – о том, почему это надо более подробно я [упоминал тут](https://jtprog.ru/posts/dev-and-work/).
