...
aliases:
  - '/hp1910-first-run/'
title: 'Начальная настройка коммутатора HP 1910 серии'
...
lastmod: "2026-08-09T22:10:30+03:00"
tags:
- hp1910
- network
categories: ["HowTo"]
...
> 🔄 **Обновлено 2026-08-09.** Разбил на разделы, чтобы можно было ссылаться на конкретный шаг и не листать простыню. Сама серия HP 1910 давно снята с продажи и переехала в HPE OfficeConnect, но синтаксис Comware, на котором она работает, никуда не делся — те же команды применимы к HPE 1920, 1920S и к коммутаторам H3C. Всё ниже — по-прежнему рабочая последовательность.
...
Как осуществить подключение к данному коммутатору, синтаксис команд для входа в режим конфигурирования, я написал в [предыдущей статье](https://jtprog.ru/posts/hp1910-reset-password/).

## Имя, часовой пояс и время
...
## Как смотреть и отменять настройки
