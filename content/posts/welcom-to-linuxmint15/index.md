...
С чего начинались эти метания между дистрибутивами — в [«Какую *nix-систему поставить на ноутбук?!»](/posts/change-linux/), а к чему всё это привело в итоге — в [«Как я вошёл в IT»](/posts/my-it-way/).
