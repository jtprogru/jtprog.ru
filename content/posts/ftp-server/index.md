...
Если клиент подключается, а листинг каталога висит — почти наверняка дело в режиме передачи: [FTP passive VS. FTP active](/posts/ftp-passive-vs-active/) и правилах [`iptables`](/posts/iptables-manual/).
