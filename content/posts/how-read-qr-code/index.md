...
Если зашло само упражнение «разобрать бинарную структуру руками», у меня есть ещё два таких: [как выглядит MBR](/posts/what-is-mbr/) и [как выглядит GPT](/posts/what-is-gpt/) — там тоже `dd`, `hexdump` и байты по полочкам.
