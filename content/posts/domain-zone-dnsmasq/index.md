...
На современных Ubuntu в этом месте обычно уже сидит [`systemd-resolved`](/posts/systemd-resolved/) — с ним придётся договариваться за порт 53. А что вообще происходит между «ввёл имя» и «открылась страница», разложено в [«Что происходит, когда ты открываешь сайт»](/posts/what-happens-when-you-open-website/).
