...
Подробнее про преемника — в [Как выглядит GPT](/posts/what-is-gpt/).
...
Практическая сторона вопроса — [конвертация GPT в MBR через `diskpart`](/posts/gpt-to-mbr/), когда старая Windows отказывается ставиться.
