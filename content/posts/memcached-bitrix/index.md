...
aliases:
  - '/memcached-bitrix/'
title: 'Настройка memcached в Битрикс'
...
Как правило, данную технологию советуют использовать на нагруженных проектах, поэтому она используется на таких крупных ресурсах, как Wikipedia, Facebook[^meta] и других.
...
Ещё про эксплуатацию Битрикса: [перенос сайта на хостинг с BitrixVM](/posts/bitrixvm-hosting/) и [обновление Bitrix VA](/posts/upgrade-bitrix-va/).

[^meta]: Facebook принадлежит Meta Platforms Inc. — организация признана экстремистской, её деятельность запрещена на территории РФ. Здесь упомянут только как исторический пример пользователя memcached.
