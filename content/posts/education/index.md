...
## Мой опыт с системой образования
...
## Учиться всё равно придётся самому
...
Из соседнего: как я сам добирался до первой работы в IT — в [«Как я вошёл в IT»](/posts/my-it-way/); как выглядит самообучение по роадмапу — в [«Программирование и работа»](/posts/dev-and-work/); а чтобы прочитанное не утекало сквозь пальцы, нужна [персональная база знаний](/posts/pkb-check-list/).

Сам роадмап под SRE я в итоге сел и написал: [The Way of SRE](https://jtprogru.github.io/The-Way-of-SRE/priorities/) — три ветви развития, компетенции с приоритетами и уровнями, а рядом [как собрать из этого личный план](https://jtprogru.github.io/The-Way-of-SRE/practices/personal-growth-plan/), а не список «что бы ещё почитать».
