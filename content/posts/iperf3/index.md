...
Если цифры не сходятся с ожиданиями, дальше копать стоит в сетевые параметры ядра — [«Настройка Linux для HL и защиты от DDoS»](/posts/sysctl-hl/) и в [маршруты](/posts/ubuntu-route-add/).
