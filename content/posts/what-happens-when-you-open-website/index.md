...
Если хочется превратить эту карту в план обучения, а не в разовое чтение, — те же этажи разложены по уровням и ожиданиям от инженера в листах [Networking](https://jtprogru.github.io/The-Way-of-SRE/engineering/networking/) и [Operating Systems](https://jtprogru.github.io/The-Way-of-SRE/engineering/operating-systems/) карты компетенций.
