...
Просто помимо всякий инструкций вроде [Дружим Android и Ubuntu 14.04](https://jtprog.ru/posts/android-and-ubuntu/), которая до сих пор пользуется спросом. Или же вроде [Перенос сайта на хостинг с BitrixVM](https://jtprog.ru/posts/bitrixvm-hosting/), или же [Что показывает atop?](https://jtprog.ru/posts/man-atop/), будут еще появляться статьи с моим мнением касательно чего-либо (возможно даже политики – кто знает). А некоторые статьи будут лишь анонсами того, что опубликовано в Patreon.
