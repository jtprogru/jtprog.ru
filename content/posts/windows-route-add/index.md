...
> **🔄 Обновлено 2026-05-29.** Добавил [шпаргалку с частыми командами](#шпаргалка-частые-команды) в начало, PowerShell-аналоги (`Get-NetRoute` / `New-NetRoute`) и раздел [«Тонкие места»](#тонкие-места-на-которых-легко-споткнуться).
