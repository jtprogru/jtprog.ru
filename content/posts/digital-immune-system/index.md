...
keywords:
  ...
  - инфраструктура
  - надежность
date: 2026-02-10T22:14:14+03:00
...
5. **Site Reliability Engineering (SRE)** — обеспечение непрерывности работы через автоматизацию, [SLO/SLA](/posts/slo-as-architecture-blueprint/) и культуру надежности.
...
- Уже используешь Prometheus и Grafana? Расширь их до full-stack observability с трейсингом (OpenTelemetry) и добавь к техническим метрикам [бизнесовые](/posts/business-metrics/) — иначе иммунитет видит железо, но не видит, что пользователю плохо.
...
Главное — не пытаться достичь идеала сразу. DIS — это итеративный процесс, где каждая новая практика усиливает предыдущие. Про то, чем зрелый иммунитет отличается от набора купленных практик и где цикл «измерили → подействовали» чаще всего разомкнут, я написал отдельно — [Digital Immune System: инженерия устойчивости как продукт](/posts/digital-immune-system-maturity/). А совсем приземлённые рецепты, которые работают ещё до всякого DIS, собраны в [заметках про починку прода](/posts/sre-recipes-summary/). Если раскладывать столпы по конкретным навыкам, ближе всего [Resilience Patterns](https://jtprogru.github.io/The-Way-of-SRE/engineering/resilience-patterns/) и [Chaos Engineering](https://jtprogru.github.io/The-Way-of-SRE/engineering/chaos-engineering/) из карты компетенций.
