...
aliases:
  - '/logrotate-basics/'
title: 'Ротация логов с logrotate'
...
Ротация логов — один из пунктов [чек-листа для Linux-сервера](/posts/linux-checklist/): без неё диск кончается в самый неподходящий момент.
