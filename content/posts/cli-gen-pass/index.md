...
Пароли — это вообще-то полдела: на сервер лучше ходить [по ssh-ключу](/posts/ssh-keys/), а близким объяснить логику сложного пароля проще через [отдельный разбор «для мамы, папы, бабушки и дедушки»](/posts/passwords-for-parents/).
