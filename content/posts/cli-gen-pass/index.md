...
Пароли — это вообще-то полдела: на сервер лучше ходить [по ssh-ключу](/posts/ssh-keys/), а близким объяснить логику сложного пароля проще через [отдельный разбор «для мамы, папы, бабушки и дедушки»](/posts/passwords-for-parents/). В проде же сгенерировать пароль — самая простая часть работы: дальше начинаются хранилище, наименьшие привилегии, ротация и журнал доступа. [Про это — лист про secrets management](https://jtprogru.github.io/The-Way-of-SRE/practices/secrets-management/).
