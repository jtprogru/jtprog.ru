...
title: 'Использование ПО в компании'
type: post
description: "Организация учета программного обеспечения и защиты данных в компании. Пример политики использования ПО, аудита и работы с коммерческой тайной."
keywords:
  - "учет ПО в организации"
  - "политика информационной безопасности"
  - "аудит установленного софта"
...
Сегодня я решил основательно взяться за данный вопрос (не в своей компании вообще, а именно развивать себя в данном направлении) и открыл отдельную страничку, где буду собирать те или иные документы, относящиеся к вопросам безопасности [информационной системы](https://ru.wikipedia.org/wiki/%D0%98%D0%BD%D1%84%D0%BE%D1%80%D0%BC%D0%B0%D1%86%D0%B8%D0%BE%D0%BD%D0%BD%D0%B0%D1%8F_%D1%81%D0%B8%D1%81%D1%82%D0%B5%D0%BC%D0%B0) компаний, благодаря которым можно снизить возможные риски.

> 📌 **Из 2026-го.** Той странички давно нет — она осталась на старом движке блога и до переезда не доехала, поэтому ссылку я убрал. Затея собирать шаблоны документов по безопасности в итоге не взлетела.
...
Про организационную часть того же вопроса — [«Как организовать команду сисадминов»](/posts/organize-sysadmins/). А про то, чем заканчивается беспечность сотрудников на практике, — [«Спам и шифрование или Печальная история»](/posts/bad-story/).
