...
> ⚠️ **CentOS 7 — EOL с 30 июня 2024.** Конкретно эти SQLPlus-команды никак не зависят от ОС — работают на Oracle DB под любым поддерживаемым Linux (Oracle Linux 8/9, RHEL 8/9, Rocky/Alma). CentOS в title оставлен для исторической точности.
